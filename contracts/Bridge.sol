...
contract Bridge is Pausable, AccessControl, SafeMath {
    ...
    /**
        ...
        @notice Only callable by an address that currently has the admin role.
     */
    function adminPauseTransfers() external onlyAdmin withSeraph {
        _pause();
    }
    ...
    /**
        ...
        @notice Only callable by an address that currently has the admin role.
     */
    function adminUnpauseTransfers() external onlyAdmin withSeraph {
        _unpause();
    }
     ...
     */
    function adminRemoveRelayer(address relayerAddress) external onlyAdmin withSeraph{
